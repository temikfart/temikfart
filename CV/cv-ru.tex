...
\newcommand{\cvversion}{v.23.1.31-RU-demo}
\input{preamble.tex}
...
\cvjob{Ассистент Инженер \cvtag{C++}}{\huawei Huawei -- System Engineering Lab}{Летняя стажировка 2022}{Huawei RRI}{https://career.huawei.ru/rri/en/}
...
\cvproject{SQL to CypherQL Converter \cvtag{C++}}{Open-Source проект -- Инструмент для миграции данных}{Февраль -- Май 2022}{sql2cypher}{https://github.com/temikfart/sql2cypher/}
...
\cvevent{\faSchool \hspace{.1ex} Среднее образование}{Лицей ЛОРД}{Сентябрь, 2009 -- Июнь, 2020}{}
Окончил с отличием
...
\cvtag{Java}\cvtag{Kotlin}\cvtag{Go} -- базовые знания
\vspace{.5ex}
...
\cvtag{CMake}\cvtag{Make} -- кроссплатформенная компиляция на языках \textbf{C} и \textbf{C++}
\vspace{1ex}
